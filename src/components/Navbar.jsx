...
// const Navbar = () => {
//   return (
//     <div className='w-full flex justify-between items-center px-[66px] mb-9  bg-white rounded-[15px]'>
...
//   const handleLogout = () => {
//     // Example: clear localStorage or cookies here
...
//           <IoMdPower className="size-4 text-[#333333] cursor-pointer" />
//         </button>
//       </div>
//     </div>
//   );
