...
// // Input Group Component
// const InputGroup = ({ label, type = "text", name, value, onChange, readOnly }) => (
//   <div className="flex flex-col gap-[6px]">
//     <label className="text-sm font-medium text-[#1F2937]">{label}</label>
//     <input
//       type={type}
...
//     setForm({
//       ...form,
//       serviceType: initialData.serviceTypeId?.toString() || "",
//       diagnosis: initialData.diagnosisId?.toString() || "",
//       healthStatus: initialData.healthStatusId?.toString() || "",
...
//     const payload = {
//       userId: form.userId || initialData.userId,
//       patientName: form.fullName,
//       gender: form.gender,
//       age: Number(form.age),
//       height: Number(form.height),
...
//     else console.error("Failed to update booking:", result.error);
//   };
...
//         {/* Header */}
//         <div className="flex justify-between items-center border-b pb-4 mb-6">
//           <h2 className="text-xl font-semibold text-[#111827]">Edit Booking Details</h2>
...
//         <h3 className="text-lg font-semibold mb-4">Patient Details</h3>
//         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
//           <InputGroup label="Full Name" name="fullName" value={form.fullName} onChange={handleChange} />
//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Gender</label>
//             <select name="gender" value={form.gender} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md text-sm">
//               <option value="">Select Gender</option>
//               <option value="MALE">Male</option>
//               <option value="FEMALE">Female</option>
//               <option value="OTHERS">Others</option>
//             </select>
//           </div>
//           <InputGroup label="Age" name="age" value={form.age} onChange={handleChange} />
//           <InputGroup label="Height (cm)" name="height" value={form.height} onChange={handleChange} />
//           <InputGroup label="Weight (kg)" name="weight" value={form.weight} onChange={handleChange} />

//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Health Status</label>
//             <select name="healthStatus" value={form.healthStatus?.toString() || ""} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="" disabled>Select Health Status</option>
//               {listedHealthStatus?.map(h => (
//                 <option key={h.id} value={h.id.toString()}>{h.status}</option>
//               ))}
//             </select>
//           </div>

//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Stay At</label>
//             <select name="stayAt" value={form.stayAt} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="" disabled>Now Patient stayed at</option>
//               <option value="HOSPITAL">Hospital</option>
//               <option value="RESIDENCE">Residence</option>
//               <option value="CARE_HOME">Care Home</option>
//               <option value="PSYCHIATRIC_HOME">Psychiatric Homes</option>
...
//           <InputGroup label="Contact Person" name="contactPersonName" value={form.contactPersonName} onChange={handleChange} />
//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Relation to Patient</label>
//             <select name="contactPersonRelation" value={form.contactPersonRelation} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="">Relationship with patient</option>
//               <option value="SELF">Self</option>
//               <option value="Wife">Wife</option>
//               <option value="Husband">Husband</option>
...
//           <InputGroup label="Email" name="contactPersonEmail" type="email" value={form.contactPersonEmail} onChange={handleChange} />
//           <InputGroup label="Mobile Number" name="contactPersonMobileNumber" value={form.contactPersonMobileNumber} onChange={handleChange} />
//         </div>
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Diagnosis</label>
//             <select name="diagnosis" value={form.diagnosis?.toString() || ""} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="" disabled>Select Diagnosis</option>
//               {listedDiagnoses?.map(d => (
//                 <option key={d.id} value={d.id.toString()}>{d.diagnosis}</option>
//               ))}
//             </select>
//           </div>

//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Service Type</label>
//             <select name="serviceType" value={form.serviceType?.toString() || ""} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="" disabled>Service Required</option>
//               {listedServices?.map(s => (
//                 <option key={s.id} value={s.id.toString()}>{s.service}</option>
//               ))}
//             </select>
//           </div>

//           <InputGroup label="Start Date" name="startDate" type="date" value={form.startDate} onChange={handleChange} />
//           <InputGroup label="Start Time" name="startTime" type="time" value={form.startTime} onChange={handleChange} />
//           <InputGroup label="End Time" name="endTime" type="time" value={form.endTime} onChange={handleChange} />

//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Duration Type</label>
//             <select name="durationType" value={form.durationType} onChange={handleChange} className="w-[328px] h-[40px] rounded-[15px] px-4 border border-gray-300">
//               <option value="" disabled>Single Visit / Periodically</option>
//               <option value="ONE_TIME_VISIT">One-time visit</option>
//               <option value="FEW_DAYS">Few Days</option>
//               <option value="FEW_WEEKS">Few Weeks</option>
//               <option value="LONG_TERM">Long-term</option>
...
//             </select>
//           </div>
//           <InputGroup label="Duration Value (weeks)" name="durationValue" type="number" value={form.durationValue} onChange={handleChange} />

//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Flexibility</label>
//             <select name="flexibility" value={form.flexibility} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
...
//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Schedule Type</label>
//             <select name="scheduleType" value={form.scheduleType} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
...
//           {/* Weekdays */}
//           <InputGroup label="Weekdays (comma separated)" name="weekdays" value={form.weekdays?.join(", ")} readOnly />
//           <div className="grid grid-cols-2 gap-2 my-4">
...
//             <select name="preferredGender" value={form.preferredGender} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="">Select Gender</option>
//               <option value="MALE">Male</option>
//               <option value="FEMALE">Female</option>
//             </select>
...
//           <InputGroup label="Preferred Languages (comma separated)" name="preferredLanguages" value={form.preferredLanguages?.join(", ")} readOnly />
//           <div className="grid grid-cols-2 gap-2 my-4">
//             {["HINDI","KANNADA","ENGLISH","MALAYALAM","TAMIL","TELUGU"].map(lang => (
//               <label key={lang} className="inline-flex items-center gap-2">
//                 <input
//                   type="checkbox"
//                   checked={form.preferredLanguages.includes(lang)}
...
//         {/* Footer Buttons */}
//         <div className="flex justify-end gap-3 mt-4">
//           <button onClick={onClose} className="px-5 py-2 rounded-md bg-gray-200 text-gray-800 hover:bg-gray-300 transition">Cancel</button>
//           <button onClick={handleSave} className="px-6 py-2 rounded-md bg-[#2152bd] text-white hover:bg-[#1D4ED8] transition">Save Changes</button>
//         </div>
//       </div>
//     </div>
//   );
...
//     const result = await updateExistingBooking(form.id, payload);
//     if (result.success) {
//       onSave(result.data);
//     } else {
...
//           <div className="flex flex-col gap-[6px]">
//             <label className="text-sm font-medium text-[#1F2937]">Gender</label>
//             <select name="gender" value={form.gender} onChange={handleChange} className="w-full px-3 py-2 border border-[#D1D5DB] rounded-md">
//               <option value="">Select Gender</option>
//               <option value="MALE">Male</option>
//               <option value="FEMALE">Female</option>
//               <option value="OTHERS">Others</option>
...
//               <option value="" disabled>Select Health Status</option>
//               {listedHealthStatus?.map((h) => (
//                 <option key={h.id} value={h.id}>{h.status}</option>
//               ))}
//             </select>
//           </div>
...
//           <InputGroup label="Start Time" name="startTime" type="time" value={form.startTime} onChange={handleChange} />
//           <InputGroup label="End Time" name="endTime" type="time" value={form.endTime} onChange={handleChange} />
//           <InputGroup label="Duration Value" name="durationValue" type="number" value={form.durationValue} onChange={handleChange} />
//           <InputGroup label="Duration Type" name="durationType" value={form.durationType} onChange={handleChange} />
//           <InputGroup label="Schedule Type" name="scheduleType" value={form.scheduleType} onChange={handleChange} />
//           <InputGroup label="Flexibility" name="flexibility" value={form.flexibility} onChange={handleChange} />
//           <InputGroup label="Weekdays (comma separated)" name="weekdays" value={form.weekdays.join(", ")} onChange={(e) => handleCheckboxChange("weekdays", e.target.value)} />
//           <InputGroup label="Preferred Gender" name="preferredGender" value={form.preferredGender} onChange={handleChange} />
//           <InputGroup label="Preferred Languages (comma separated)" name="preferredLanguages" value={form.preferredLanguages.join(", ")} onChange={(e) => handleCheckboxChange("preferredLanguages", e.target.value)} />
