...
//       if (menu.link && pathname.startsWith(menu.link)) {
//         matchedParent = menu.name;
//         return true;
//       }
...
//       setActive(matchedParent);
//       setOpenSubmenu(null);
//     } else {
//       setActive("Home");
//       setOpenSubmenu(null);
//     }
//   }, [pathname, allowedMenus]);
...
//   /* ===================== RENDER ===================== */
//   return (
//     <div className="h-full bg-white rounded-[16px] border border-[#8888884d] ps-12 pe-8 pb-8">
//       <div className="h-[75%]">
...
//               className={`rounded-lg flex items-center justify-between mt-5 cursor-pointer ${
//                 active === item.name ||
//                 item.submenu?.some((s) => s.name === active)
//                   ? "text-[#3674B5] font-semibold bg-[#F0F4F9] p-2"
//                   : "text-black"
//               }`}
//               onClick={() => handleMenuClick(item)}
