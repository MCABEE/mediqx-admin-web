...
//   const { updateSupervisorPageOne } = useSupervisorRegistrationStore();
...
//     await updateSupervisorPageOne(supervisor.id, form);
//     onClose();
//   };
...
//         <h2 className="text-lg font-semibold mb-4">Edit Basic Details</h2>

//         {["fullName", "email"].map((f) => (
//           <input
//             key={f}
...
//           className="border p-2 w-full text-left rounded mb-4"
//         >
//           {form.mapLocation || "Pick location"}
//         </button>
...
// /* ---------- Input Components (same style as Nurse modal) ---------- */
// const InputField = ({
//   label,
//   value,
//   onChange,
...
//     <>
//       <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
//         <div className="relative bg-white w-full max-w-2xl max-h-[90vh]
