...
//   error: null,
//   success: false,
//   duplicateIndexes: [], // 🔴 new field to store which rows are duplicates
...
//       });
//     } catch (err) {
//       // 🔴 Handle duplicate composite keys (409)
//       if (
...
//         // find which entries in our local array match these duplicates
