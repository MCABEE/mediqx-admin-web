...
// function Page() {
//   const { ambulances, loading, fetchAmbulances } = useAmbulanceStore();

//   // take first ambulance
//   const ambulance = ambulances?.[0];

//   useEffect(() => {
//     fetchAmbulances(1, { filter: "ALL" });
//   }, []);
...
//         <div className="flex border-t border-[#BBBBBB] py-4 w-full px-6">
//           <div className="flex gap-4 py-[24px]">
//             <button className="w-[192px] h-[40px] bg-[#FFD1D9] rounded-[15px]">
//               Cancel Service
//             </button>

//             <button className="w-[192px] h-[40px] border rounded-[15px]">
//               Edit Service
//             </button>
...
//   if (!ambulance) {
//     return <div className="text-center mt-6">No ambulance data found</div>;
//   }
...
//       <div className="mb-2 bg-white border rounded-[15px] mt-2">
...
//         <div className="flex border-t px-6 py-4 gap-4">
//           <button className="w-[192px] h-[40px] bg-[#FFD1D9] rounded">
//             Cancel Service
//           </button>

//           <button
//             onClick={() => setEditData(ambulance)}
//             className="w-[192px] h-[40px] border rounded"
//           >
//             Edit Service
//           </button>

//           <button className="w-[192px] h-[40px] bg-[#09B438] text-white rounded">
//             Confirm
//           </button>
//         </div>
//       </div>
...
//           <div
//             key={ambulance.id}
//             className="bg-white border rounded-[15px]"
//           >
//             {/* HEADER */}
...
//               <button className="w-[160px] h-[40px] bg-[#FFD1D9] rounded">
//                 Cancel Service
//               </button>

//               <button className="w-[160px] h-[40px] bg-[#09B438] text-white rounded">
//                 Confirm
//               </button>
//             </div>
//           </div>
  ...
  <div className="flex justify-between items-center gap-4 my-8">
    ...
    >
      ...
      <ConfirmationPopup
        ...
        confirmText={
          confirmPopup.type === "CONFIRM" ? "Confirm" : "Cancel"
        }
