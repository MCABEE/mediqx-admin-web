    ...
    <div>
        ...
        {/* Filter header */}
              ...
              <div className="w-full bg-white border border-[#8888888c] rounded-[15px] mt-2 pt-[23px] pb-[19px]  px-6 text-black font-semibold text-[32px] flex justify-between">
                {/* <p>{totalBookings}</p> */}
                <p>123</p>
                <input type="search" name="" placeholder='Search patient Name' className='w-[360px] h-[48px] border-1 border-[#888888] rounded-[15px] placeholder:text-[#888888] text-[14px] px-4 outline-none' id="" />
