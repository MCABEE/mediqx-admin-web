...
//     if (category === "specializations") addSpecializationField();
//     else if (category === "qualifications") addQualificationField();
//     else if (category === "workingDepartments") addWorkingDepartmentField();
//     else if (category === "skills") addSkillField();
//   };

//   const handleInputChange = (category, idx, value) => {
//     if (category === "specializations") setSpecializationValue(idx, value);
//     else if (category === "qualifications") setQualificationValue(idx, value);
//     else if (category === "workingDepartments") setWorkingDepartmentValue(idx, value);
//     else if (category === "skills") setSkillValue(idx, value);
//   };
...
//         <h2 className="text-[#3674B5] font-semibold mb-2">Specialization</h2>
...
//               value={val}
//               disabled={isLoading}
//               onChange={(e) => handleInputChange("specializations", idx, e.target.value)}
//             />
...
//               value={val}
//               disabled={isLoading}
//               onChange={(e) => handleInputChange("qualifications", idx, e.target.value)}
//             />
...
//       {/* Working Departments */}
//       <section className="p-6 bg-white mt-4 rounded shadow">
//         <h2 className="text-[#000000] font-semibold mb-2">Working Departments</h2>
...
//               value={val}
//               disabled={isLoading}
//               onChange={(e) => handleInputChange("workingDepartments", idx, e.target.value)}
//             />
...
//       {success && (
//         <p className="text-green-600 font-semibold px-6 mt-4">Data saved successfully!</p>
//       )}
//       {error && (
//         <p className="text-red-600 font-semibold px-6 mt-4 whitespace-pre-wrap">{error}</p>
//       )}
//     </div>
//   );
// }
...
function AddRegNursesPage({ category = "REG_NURSES" }) {
  ...
  return (
    <div>
      ...
      {success && (
        <p className="text-blue-600 font-semibold px-6 my-4">Data saved successfully!</p>
      )}
      {error && (
        <p className="text-red-600 font-semibold px-6 mt-4 whitespace-pre-wrap">{error}</p>
      )}
