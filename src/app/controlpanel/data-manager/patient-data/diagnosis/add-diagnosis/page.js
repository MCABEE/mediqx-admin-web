...
//             <Link href={" /controlpanel/data-manager/patient-data/diagnosis/manage-diagnosis"} className="text-black">Manage</Link>
//           </div>
...
function AddDiagnosisPage() {
  ...
  return (
    <div>
      ...
      {success && (
        <div className="text-blue-600 font-semibold mt-2">Diagnoses added successfully!</div>
      )}
