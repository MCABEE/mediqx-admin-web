...
//   const handleSave = () => {
//     console.log("Saving diagnoses:", diagnosisInputs);
//     addDiagnoses();
//   };
...
//     setDiagnosisInputValue(idx, value);
//     // Remove this value from duplicate highlights immediately
//     setDuplicateNames((prev) => prev.filter((n) => n !== value.toLowerCase()));
//   };
...
//               placeholder="Enter Diagnosis"
//               value={value}
//               // Input is always editable unless loading is true
//               disabled={loading}
//               onChange={(e) => handleInputChange(idx, e.target.value)}
//             />
//           </div>
