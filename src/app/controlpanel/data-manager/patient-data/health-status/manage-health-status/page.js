...
//             <Link href={" /controlpanel/data-manager/patient-data/health-status/add-health-status"} className="text-black">Add</Link>
...
// <h1 className="text-black font-semibold py-[16px] ">Manage Health Status</h1>
//       </div>
...
//             <input type="text" className="w-[350px] border border-[#8888888c] py-2 px-4 rounded-[15px] outline-none" placeholder="Enter Health Status"/>
//             <input type="checkbox" className="size-6 rounded-[15px]" />

//       </div>
//        <div className="bg-white flex  items-center gap-2 px-6 py-2 mt-2">
//         <div className="border border-[#8888888c] py-2 px-4 rounded-[15px]">02</div>
//             <input type="text" className="w-[350px] border border-[#8888888c] py-2 px-4 rounded-[15px] outline-none" placeholder="Enter Enter Health Status"/>
//             <input type="checkbox" className="size-6 rounded-[15px]" />
  ...
  return (
    <div className="fixed inset-0 bg-[#4f4f4f4c] backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-2xl shadow-md w-[350px]">
        ...
        <p>Are you sure you want to delete the status <strong>{statusName}</strong>?</p>
