...
//       <div className="w-full bg-[#C0D8F6] mt-2 rounded-t-[15px] px-6">
//         <h1 className="text-black font-semibold py-[16px]">Add Health Status</h1>
//       </div>
...
//   const handleInputChange = (idx, value) => {
//     // Always update the store value
//     setServiceInputValue(idx, value);
//     // Remove this value from duplicate highlights
//     setDuplicateNames((prev) => prev.filter((n) => n !== value.toLowerCase()));
//   };
...
//               placeholder="Enter Health Status"
//               value={value}
//               disabled={loading} // keep editable if not loading
//               onChange={(e) => handleInputChange(idx, e.target.value)}
//             />
//           </div>
//         );
        ...
        return (
          <div key={idx} className="bg-white flex gap-6 px-6 py-2 mt-2">
            ...
            <input
              ...
              placeholder="Enter Health Status"
              value={value}
              disabled={isSubmitting && !error} // allow typing even after duplicate error
              onChange={(e) => handleInputChange(idx, e.target.value)}
            />
          </div>
        );
