...
//             <Link
//               href={
//                 "/controlpanel/data-manager/general-data/languages/manage-languages"
//               }
...
//   // Check for local duplicates on every change
//   useEffect(() => {
//     const seen = {};
//     const duplicates = [];
...
//     // Reset previous duplicate indices
//     setDuplicateIndices([]);

//     // Check for local duplicates first
//     const trimmedLanguages = languages.map((l) => l.trim()).filter(Boolean);
//     const seen = {};
//     const localDuplicates = [];
//     trimmedLanguages.forEach((lang, idx) => {
//       if (seen[lang]) {
//         localDuplicates.push(idx, seen[lang]);
//       } else {
//         seen[lang] = idx;
//       }
//     });
...
//       setDuplicateIndices([...new Set(localDuplicates)]);
//       return;
//     }
...
//       if (err?.response?.data?.error?.details?.duplicates) {
//         const apiDuplicates = err.response.data.error.details.duplicates.map(
//           (d) => languages.findIndex((l) => l.trim() === d.value)
//         );
