...
//             <Link href={" /controlpanel/data-manager/general-data/languages/add-languages"} className="text-black">Add</Link>
...
//           <div key={lang._id} className="bg-white flex items-center gap-2 px-6 py-2 mt-2">
...
//               checked={checkedItems.includes(lang._id)}
//               onChange={() => handleCheckbox(lang._id)}
//             />
//           </div>
//         ))
//       )}
...
// function ConfirmDeletePopup({ ids, onConfirm, onCancel }) {
//   return (
...
//         <p>Are you sure you want to delete {ids.length} language(s)?</p>
...
const handleUpdate = async () => {
  ...
  try {
    ...
    if (
      ...
      setApiError("This language already exists.");
    } else {
